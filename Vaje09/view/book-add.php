...
<form action="<?= BASE_URL . "book/add" ?>" method="post">
    ...
    <p><label>Price: <input type="number" name="price" value="<?= $book["price"] ?>" required min="0" step="any"/>
        <span class="important"><?= $errors["price"] ?></span></label></p>
    <p><label>Year: <input type="number" name="year" value="<?= $book["year"] ?>" required min="1500" max="2020"/>
