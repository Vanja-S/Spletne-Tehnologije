...
if (isset($_POST["first_name"]) and isset($_POST["last_name"]) and !empty($_POST["last_name"]) and !empty($_POST["first_name"])) {
...
<ul>
    <li>
        <pre>first_name</pre> representing the value in the first input field, and
    </li>
    <li>
        <pre>last_name</pre> representing the value in the second input field.
    </li>
</ul>
